...
{{--                    <hr>--}}
            ...
            <div class="my-3">
                <form class="d-flex flex-wrap justify-content-center bg-light shadow-sm  p-2 rounded" method="post" action="{{url('admin/orders/create')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="my-2 col-12 col-sm-12 col-md-6 p-1">
                        ...
                        <input class="form-control" type="text" name="phone_number" value="{{old('phone_number')}}" placeholder="رقم موبايل المستخدم" title="رقم موبايل المستخدم">
                        <span class="text-danger">
