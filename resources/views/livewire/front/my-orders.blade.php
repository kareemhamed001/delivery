    ...
    <section class="container d-flex flex-column  py-5">
        ...
        <div class="d-flex flex-column  w-100 flex-wrap align-items-center justify-content-center py-2">
            ...
            <div class="d-flex container w-100 flex-column  justify-content-center ">
                ...
                <a href="{{url('delivered_orders')}}" class="orders-labels-card p-0 text-decoration-none col-12 col-sm-12  col-md-12 col-lg-12 col-xl-12 col-xxl-12  m-1 bg-light overflow-hidden rounded border border-1 h-xxl-175-px h-xl-150-px h-sm-200-px h-md-150-px">
                    {{--                <img src="{{asset('assets/images/food_italian_italian_food.jpg')}}" alt="">--}}

                    <div class="d-flex text-decoration-none w-100 h-100  ">
                        <div
                            class="col-6 col-sm-6 col-md-6 col-lg-3 col-xl-3 h-100 bg-success d-flex justify-content-center align-items-center ">

                            <svg class="w-100 h-75 " xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"
                                 width="618.67538" height="487.32493" viewBox="0 0 618.67538 487.32493"
                                ...
                                <path
                                    ...
                                    transform="translate(-290.66231 -206.33753)" fill="#f9a826"/>
                                <path
                                ...
                                <circle cx="120.11268" cy="324.71266" r="35.81102" fill="#f9a826"/>
                                <path
                        ...
                        <div
                            class="col-6 col-sm-6 col-md-6 col-lg-9 col-xl-9 details-section border-0  p-2 position-relative">
                            <div class="h3 text-dark">Delivered Orders</div>
                            <div class=" text-dark">Find deals, free delivery, and more from our restaurant partners.
                            </div>
                            <div class="card-cta"> Explore</div>
                        </div>
                ...
                <a href="{{url('canceled_orders')}}" class="orders-labels-card p-0 text-decoration-none col-12 col-sm-12  col-md-12 col-lg-12 col-xl-12 col-xxl-12  m-1 bg-light overflow-hidden rounded border border-1 h-xxl-175-px h-xl-150-px h-sm-200-px h-md-150-px">
                    {{--                <img src="{{asset('assets/images/food_italian_italian_food.jpg')}}" alt="">--}}

                    <div class="d-flex text-decoration-none w-100 h-100  ">
                        <div
                            class="col-6 col-sm-6 col-md-6 col-lg-3 col-xl-3 h-100 bg-danger d-flex justify-content-center align-items-center ">

                            <svg class="w-100 h-75" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="790"
                                ...
                                <path
                                    ...
                                    transform="translate(-205 -193.89598)" fill="#2f2e41"/>
                                <circle cx="361.7217" cy="403.5046" r="62.98931" fill="#f9a826"/>
                                <path
                                    ...
                                    transform="translate(-205 -193.89598)" fill="#f9a826"/>
                            </svg>
                        </div>

                        <div
                            class="col-6 col-sm-6 col-md-6 col-lg-9 col-xl-9 details-section border-0  p-2 position-relative">
                            <div class="h3 text-dark">Canceled Orders</div>
                            <div class=" text-dark">Find deals, free delivery, and more from our restaurant partners. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad beatae commodi dolorem ea eos est eum illo molestias natus nulla odit officia, optio quasi quia, quo similique temporibus, ut voluptatibus.
                            </div>
                            <div class="card-cta"> Explore</div>
                        </div>
                    </div>
