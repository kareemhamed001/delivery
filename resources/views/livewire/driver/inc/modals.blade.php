...
<div wire:ignore.self class="modal fade" id="cancelOrderModal" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" wire:click="closeModal">close
                </button>
                <button type="button" class="btn btn-danger" wire:click="cancelOrder">Yes,delete</button>
            </div>
        </div>
    </div>
</div>
