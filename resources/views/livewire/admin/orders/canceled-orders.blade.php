<div>
    ...
    <div>
        <h4 class="h4 font-weight-bold text-gray-800">Canceld Orders </h4>
        ...
        <div class="row ">
            ...
            <div class="table-responsive ">
                ...
                <table class="table font-size-card  table-sm table-hover mw-100">
                    ...
                    <caption>List of avilable
                        orders {{$orders->count().'canceled-orders.blade.php/'.$orders->total()}}</caption>
                    <thead class="table-primary">
                    <tr>
                        <th class="col-1 col-md-1 cursor-pointer py-2" wire:click="orderBy('id')">id <i
                        ...
                        <th class="col-1 col-md-1 cursor-pointer py-2" wire:click="orderBy('delivery_time')">Time <i
                                    class="fa-solid fa-caret-down"></i></th>
                    ...
                    @forelse($orders as $order)
                        ...
                        <tr class="cursor-pointer">
                            ...
                            <td class="d-none d-sm-table-cell"
                                wire:click="showOrder('{{ $order->hashed_id }}')">{{$order->name}}</td>

                            <td wire:click="showOrder('{{ $order->hashed_id }}')">{{$order->from_address}}</td>
                            <td class="d-none d-sm-table-cell"
                                wire:click="showOrder('{{$order->hashed_id}}')">{{$order->to_address}}</td>
