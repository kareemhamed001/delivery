...
@section('content')
    ...
    <section
        class="w-100 d-none d-sm-flex vh-75 px-5  mb-5  position-relative  bg-primary justify-content-center  ">

        <div class="w-100 h-80 d-flex justify-content-start align-items-center pt-3 shadow-lg ">
            <div class="col-6 h-100 overflow-hidden d-flex align-items-center justify-content-center">
                <svg data-aos="slide-right" class="w-100 h-60" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"
                    ...
                    <path
                        ...
                        transform="translate(-185.5 -267.58547)" fill="#f9a826"/>
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-185.5 -267.58547)" fill="#f9a826"/>
                    <ellipse cx="265.00977" cy="231.82903" rx="14" ry="17" fill="#f9a826"/>
            ...
            <div class=" col-auto h-100 bg-transparent p-0 text-white  ">
                ...
                <div class="d-flex flex-column justify-content-between align-items-start h-100">
                    <div class="d-flex flex-column justify-content-center align-items-start h-50">
                        <h1 data-aos="slide-left" class="font-roboto">{!! __('homePage.CoverHeader')  !!}</h1>
                        <h4 data-aos="slide-left" class="font-cairo">{!!__('homePage.CoverSubheader')!!}</h4>
                    </div>
        ...
        <div class="col-4 h-30 position-absolute top-100 start-50 translate-middle shadow overflow-hidden">
            <img data-aos="zoom-in" class="w-100 h-100" src="{{asset('assets/images/pexels-cottonbro-4604666.jpg')}}"
                 alt=""
                        ...
                        <div
                            ...
                            <svg class="w-100 h-100" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="906"
                                ...
                                <path d="M507,287.15147V173.238H414V286.79924a143.61506,143.61506,0,0,1,93,.35223Z"
                                      transform="translate(-182 -64.23796)" fill="#C70039FF"/>
                    ...
                    <div class="d-flex flex-column flex-sm-column flex-md-row  text-decoration-none w-100 h-100 ">
                        <div
                            ...
                            <svg class="w-100 h-100" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="850"
                                ...
                                <path
                                    d="M592.00977,480.0937h-95.981L495.01123,450.583a8.85956,8.85956,0,0,1,9.93091-9.09863l55.85449,6.83936h.00684a31.29061,31.29061,0,0,1,31.2063,31.27Z"
                                    transform="translate(-185.5 -267.58547)" fill="#C70039FF"/>
                                <path
                                    d="M549.23082,375.4145H482.28871a6.77712,6.77712,0,0,0-6.77894,6.77894v66.94211a6.77713,6.77713,0,0,0,6.77894,6.77895h66.94211a6.77714,6.77714,0,0,0,6.779-6.77895V382.19344A6.77713,6.77713,0,0,0,549.23082,375.4145Z"
                                    transform="translate(-185.5 -267.58547)" fill="#ccc"/>
                                <path
                                ...
                                <path
                                    d="M753.1499,394.57447a23.54938,23.54938,0,0,1-8.80029,18.34,29.98827,29.98827,0,0,1-19.69971-41.3,23.50519,23.50519,0,0,1,28.5,22.96Z"
                                    transform="translate(-185.5 -267.58547)" fill="#C70039FF"/>
                                <ellipse cx="265.00977" cy="231.82903" rx="14" ry="17" fill="#C70039FF"/>
                                <polygon
                                ...
                                <path
                                    d="M620.94513,369.15135l-5.827,23.61966a4.81688,4.81688,0,0,1-6.503,3.3034l-22.44252-9.19753a13.37737,13.37737,0,0,1,6.48437-25.957l24.06772,2.28255a4.81687,4.81687,0,0,1,4.22042,5.94888Z"
                                    transform="translate(-185.5 -267.58547)" fill="#C70039FF"/>
                                <circle cx="519.00977" cy="136.82903" r="7" fill="#C70039FF"/>
                                <path
                                    d="M1014.5,631.4145a1.00308,1.00308,0,0,1-1,1h-827a1,1,0,0,1,0-2h827A1.00308,1.00308,0,0,1,1014.5,631.4145Z"
                                    transform="translate(-185.5 -267.58547)" fill="#3f3d56"/>
                            </svg>
                ...
                <div class="card-img img-fluid h-50">
                    <svg class="w-100 h-100" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="618.67538"
                        ...
                        <path
                            ...
                            transform="translate(-290.66231 -206.33753)" fill="#C70039FF"/>
                        <path
                        ...
                        <circle cx="120.11268" cy="324.71266" r="35.81102" fill="#C70039FF"/>
                        <path
