...
@section('content')
    ...
    <section style="background-image: linear-gradient(to bottom, var(--primary) 0%, var(--secondry) 100%);"
        class="w-100  d-flex vh-75 px-3 px-sm-5   position-relative  bg-primary justify-content-center border-0  ">

        <div class="w-100 h-80 d-flex justify-content-start align-items-center pt-3 shadow-lg ">
            <div class="col-6 h-100 overflow-hidden d-none d-md-flex align-items-center justify-content-center">
                <svg data-aos="slide-right" class="w-100 h-60" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"
                     width="829" height="364.82907" viewBox="0 0 829 364.82907"
                    ...
                    <path
                        ...
                        transform="translate(-185.5 -267.58547)" fill="var(--primary)"/>
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-185.5 -267.58547)" fill="var(--primary)"/>
                    <ellipse cx="265.00977" cy="231.82903" rx="14" ry="17" fill="var(--primary)"/>
                    <polygon points="450.071 292.005 462.331 292.005 468.164 260.208 450.069 260.209 450.071 292.005"
                             fill="#ffb8b8"/>
                    <path
                    ...
                    <polygon points="443.071 295.005 455.331 295.005 461.164 263.208 443.069 263.209 443.071 295.005"
                             fill="#ffb8b8"/>
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-185.5 -267.58547)" fill="var(--primary)"/>
                    <circle cx="519.00977" cy="136.82903" r="7" fill="var(--primary)"/>
                    <path
                        d="M1014.5,631.4145a1.00308,1.00308,0,0,1-1,1h-827a1,1,0,0,1,0-2h827A1.00308,1.00308,0,0,1,1014.5,631.4145Z"
                        transform="translate(-185.5 -267.58547)" fill="#3f3d56"/>
                </svg>
            </div>
            <div class=" col-12 col-sm-auto col-auto h-100 bg-transparent p-3 p-md-0 text-white   ">
                ...
                <div class="d-flex flex-column justify-content-between align-items-start h-100">
                    <div class="d-flex flex-column justify-content-center align-items-start h-50">
                        <h2 data-aos="slide-left" class="font-roboto ">{!! __('homePage.CoverHeader')  !!}</h2>
                        <h4 data-aos="slide-left" class=" ">{!!__('homePage.CoverSubheader')!!}</h4>
                    </div>

                    <div class="d-flex flex-column  justify-content-center align-items-start h-50 ">
                        <h4 class="font-lato  ">{!!__('homePage.ContactUs')!!}</h4>
                        <div data-aos="slide-left"
                             class="col-9 col-md-9 d-flex justify-content-between">
                            <a href="https://www.facebook.com/kareemhamid001/" target="_blank"><i
                                    class="fa-brands fa-facebook btn btn-sm text-white cursor-pointer  d-block font-size-icon  font-weight-3"></i></a>
                            <a href="https://api.whatsapp.com/send?phone=+2001118604521&text=Hello" target="_blank"><i
                                    class="fa-brands fa-whatsapp btn btn-sm cursor-pointer text-green d-block font-size-icon font-weight-3"></i></a>
        ...
        <div class="custom-shape-divider-bottom-1663345094 ">
...
{{--        <div class="custom-shape-divider-bottom-1663371914">--}}
            ...
            <div class="d-flex container w-100 flex-column  justify-content-center ">
                <a data-aos="fade-down" data-aos-offset="200" data-aos-duration="1000" href="{{url('order')}}"
                   class="orders-labels-card text-decoration-none col-12 m-1 p-0 bg-light overflow-hidden rounded-1 border border-1 h-xs-200-px h-sm-200-px h-md-150-px h-lg-150-px h-xl-150-px h-xxl-150-px  ">
                    <div class="d-flex flex-column flex-sm-column flex-md-row  text-decoration-none w-100 h-100  ">
                        <div
                            class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 h-xs-50 h-sm-50 h-md-100 bg-primary d-flex justify-content-center align-items-center ">
                ...
                <a data-aos="fade-up" data-aos-offset="200" data-aos-duration="1000"
                   ...
                   class="orders-labels-card text-decoration-none col-12 m-1 p-0 bg-light overflow-hidden rounded-1 border border-1 h-xs-200-px h-sm-200-px h-md-150-px h-lg-150-px h-xl-150-px h-xxl-150-px  ">
                    ...
                    <div class="d-flex flex-column flex-sm-column flex-md-row  text-decoration-none w-100 h-100 ">
                        <div
                            class="bg-secondary col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 h-xs-50 h-sm-50 h-md-100  d-flex justify-content-center align-items-centerr ">
            ...
            <div data-aos="zoom-in" class="card bg-transparent my-2 overflow-hidden p-2 rounded-0 border-0  col-12 col-sm-12 col-md-4 col-lg-4 "
                ...
                <div class="card-img img-fluid h-50">
                    <svg class="w-100 h-100" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="829"
                        ...
                        <path
                            d="M592.00977,480.0937h-95.981L495.01123,450.583a8.85956,8.85956,0,0,1,9.93091-9.09863l55.85449,6.83936h.00684a31.29061,31.29061,0,0,1,31.2063,31.27Z"
                            transform="translate(-185.5 -267.58547)" fill="var(--secondry)"/>
                        <path
                            d="M549.23082,375.4145H482.28871a6.77712,6.77712,0,0,0-6.77894,6.77894v66.94211a6.77713,6.77713,0,0,0,6.77894,6.77895h66.94211a6.77714,6.77714,0,0,0,6.779-6.77895V382.19344A6.77713,6.77713,0,0,0,549.23082,375.4145Z"
                            transform="translate(-185.5 -267.58547)" fill="#ccc"/>
                        <path
                        ...
                        <path
                            d="M753.1499,394.57447a23.54938,23.54938,0,0,1-8.80029,18.34,29.98827,29.98827,0,0,1-19.69971-41.3,23.50519,23.50519,0,0,1,28.5,22.96Z"
                            transform="translate(-185.5 -267.58547)" fill="var(--secondry)"/>
                        <ellipse cx="265.00977" cy="231.82903" rx="14" ry="17" fill="var(--secondry)"/>
                        <polygon
                            points="450.071 292.005 462.331 292.005 468.164 260.208 450.069 260.209 450.071 292.005"
                            fill="#ffb8b8"/>
                        <path
                        ...
                        <path
                            d="M620.94513,369.15135l-5.827,23.61966a4.81688,4.81688,0,0,1-6.503,3.3034l-22.44252-9.19753a13.37737,13.37737,0,0,1,6.48437-25.957l24.06772,2.28255a4.81687,4.81687,0,0,1,4.22042,5.94888Z"
                            transform="translate(-185.5 -267.58547)" fill="var(--secondry)"/>
                        <circle cx="519.00977" cy="136.82903" r="7" fill="var(--secondry)"/>
                        <path
                            d="M1014.5,631.4145a1.00308,1.00308,0,0,1-1,1h-827a1,1,0,0,1,0-2h827A1.00308,1.00308,0,0,1,1014.5,631.4145Z"
                            transform="translate(-185.5 -267.58547)" fill="#3f3d56"/>
                    </svg>
